...
ขั้นตอนที่ 2, 3 ในที่นี้ใช้ internal Python networking interface -- สำหรับผู้สนใจตัวอย่าง code ที่ทำแบบเดียวกันโดยใช้ PySpark ดูได้ที่ [XXXXXXXXXXXXXXXXXXXXX](nnnnnnnnnnnnnnn)
...
{% include image.html
  ...
  title='BNK48'
  caption='BNK48 -- Thank <a href="http://www.metalbridges.com/bnk48/</a> for the picture.'
%}
...
<img src="assets/img/twitterBNK48/twitterApp_01.png" alt="twitterApp_firstPage" style="width: 700px;"/>
...
<img src="assets/img/twitterBNK48/twitterApp_02.png" alt="twitterApp_createApp" style="width: 700px;"/>
...
<img src="assets/img/twitterBNK48/twitterApp_03.png" alt="twitterApp_keys" style="width: 700px;"/>

#### หลังจากนั้นก็สร้างและบันทึก a Python script ตามไฟล์ที่แนบไว้นี้ครับ ([คลิกเพื่อดูไฟล์](ghj) -- ในตัวอย่างตั้งชื่อว่า streamingTwitterTags.py)
...
<img src="bnk_ranking.png" alt="chart_example" style="width: 700px;"/>
