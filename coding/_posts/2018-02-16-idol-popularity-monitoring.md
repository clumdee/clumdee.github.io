...
<div class="my-4 text-center">
  <img class="w-75" src="{{ site.url }}/coding/img/twitterBNK48/bnk_stream-2018-02-14_21-16-10.gif">
</div>
...
{% include image.html
  img='coding/img/twitterBNK48/BNK48.jpg'
  title='BNK48'
...
<div class="my-4 text-center">
  <img class="w-75" src="{{ site.url }}/coding/img/twitterBNK48/twitterApp_01.png"
  alt="twitterApp_firstPage">
</div>
...
<div class="my-4 text-center">
  <img class="w-75" src="{{ site.url }}/coding/img/twitterBNK48/twitterApp_02.png"
  alt="twitterApp_createApp">
</div>
...
<div class="my-4 text-center">
  <img class="w-75" src="{{ site.url }}/coding/img/twitterBNK48/twitterApp_03.png"
  alt="twitterApp_keys">
</div>

#### หลังจากนั้นก็สร้างและบันทึก Python script ตามไฟล์ที่แนบไว้นี้ครับ ([คลิกเพื่อดูไฟล์]({{ site.url }}/coding/img/twitterBNK48/streamingTwitterTags.py) -- ในตัวอย่างตั้งชื่อว่า streamingTwitterTags.py)
...
**ปล.**
ส่วน technical part 2 และ 3 ใน blog post นี้ใช้ internal Python networking interface -- สำหรับผู้สนใจตัวอย่าง code ที่ทำแบบเดียวกันโดยใช้ PySpark (สำหรับทำ distributed computation) [ดูได้ที่นี่]({{ site.url }}/coding/img/twitterBNK48/code_with_pyspark.ipynb)
...
<div class="my-4 text-center">
  <img class="w-75" src="{{ site.url }}/coding/img/twitterBNK48/twitterStreaming_run.png"
  alt="twitterStreaming_run">
</div>
...
<div class="my-4 text-center">
  <img class="w-75" src="{{ site.url }}/coding/img/twitterBNK48/bnk_ranking_with_time.png"
  alt="bnk_ranking_with_time">
</div>
...
<div class="my-4 text-center">
    <figure>
        <img class="w-50" src="{{ site.url }}/coding/img/twitterBNK48/otaku_power.jpg" alt="bnk_ranking_with_time">
        <figcaption>Otaku Power -- Thank <a
                href="https://holyonthenet.webnode.es/news/cafes-cosplay-/">https://holyonthenet.webnode.es/news/cafes-cosplay-/</a>
