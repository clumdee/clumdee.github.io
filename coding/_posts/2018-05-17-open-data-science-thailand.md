...
หรือจะคลิกดู raw jupyter notebook [ได้ที่นี่]({{ site.url }}/coding/img/open_data_thailand/OpenDataScience_code.ipynb)

<div class="my-4 text-center">
  <img class="w-75" src="{{ site.url }}/coding/img/open_data_thailand/cover.png">
</div>
...
<div class="my-4 text-center">
    <iframe class="w-100" height="550px" frameborder="0" scrolling="yes" src="//plot.ly/~chatdanai.l/46.embed"></iframe>
</div>
...
<div class="my-4 text-center">
    <iframe class="w-100" height="550px" frameborder="0" scrolling="yes" src="//plot.ly/~chatdanai.l/48.embed"></iframe>
</div>
...
<div class="my-4 text-center">
    <iframe class="w-100" height="400px" frameborder="0" scrolling="yes" src="//plot.ly/~chatdanai.l/24.embed"></iframe>
</div>
...
<div class="my-4 text-center">
  <img class="w-25" src="{{ site.url }}/coding/img/open_data_thailand/thailand_map.png"
  alt="Thailand map">
</div>
...
<div class="my-4 text-center">
    <iframe class="w-100" height="500px" frameborder="0" scrolling="yes" src="//plot.ly/~chatdanai.l/38.embed"></iframe>
</div>
...
<div class="my-4 text-center">
    <iframe class="w-100" height="500px" frameborder="0" scrolling="yes" src="//plot.ly/~chatdanai.l/40.embed"></iframe>
</div>
...
<div class="my-4 text-center">
    <iframe class="w-100" height="500px" frameborder="0" scrolling="yes" src="//plot.ly/~chatdanai.l/44.embed"></iframe>
</div>
